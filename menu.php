    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top">
      ...
      <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
          <h3><i class="fas fa-utensils mr-2"></i> DAFTAR MENU</h3><hr>
          <div class="row text-white">
          <table class="table table-dark">
            <thead>
                <tr>
                    <th scope="col">No</th>
                    <th scope="col">Kode Pangsit</th>
                    <th scope="col">Nama Pangsit</th>
                    <th scope="col">Kategori Pangsit</th>
                    <th scope="col">Awet Pangsit</th>
                </tr>
            </thead>
            <tbody>
            <?php
                    include "koneksi.php";
                    $query  = mysqli_query($koneksi_db,"select *from tbl_pangsits where kd_pangsit");
                    $no = 1;
            ...
            <tr class="odd gradeX">
                    ...
                    <td><?php echo $data['kat_pangsit'];?></td>
                    <td><?php echo $data['awet_pangsit'];?></td>
        ...
        <a href="inputpangsit.php" class="btn btn-success">Input Pangsit</a>
          </div> 
        </div>
      </div>
